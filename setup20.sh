echo 784159 | sudo apt-get update
...
ls -alh
-rwxr-xr-x 1 gentoo gentoo 85M Sep 11 2018 'FoxitReader.enu.setup.2.4.4.0911(r057d814).x64.run'
-rw-rw-r-- 1 gentoo gentoo 71M Sep 14 2018 FoxitReader.enu.setup.2.4.4.0911.x64.run.tar.gz
